        ...
        <Tab eventKey="weekly" title="Department Usage" onClick={() => setChartType("bar")}>
          <Card>
            <Card.Body>
              ...
              <Button onClick={() => exportToExcel(usageData, "Department_Usage", chartType)} variant="primary" className="mt-3">
                Export to CSV
              </Button>
            </Card.Body>
          </Card>
        ...
        <Tab eventKey="hourly" title="Tutors by Department" onClick={() => setChartType("bar")}>
          <Card>
            <Card.Body>
              ...
              <Button onClick={() => exportToExcel(tutorsData, "Tutors_by_department", chartType)} variant="primary" className="mt-3">
                Export to CSV
              </Button>
            </Card.Body>
          </Card>
        ...
        <Tab eventKey="completion" title="Sessions by Department" onClick={() => setChartType("pie")}>
          <Card>
            <Card.Body>
              ...
              <Button onClick={() => exportToExcel(sessionsData, "Sessions_by_department", chartType)} variant="primary" className="mt-3">
                Export to CSV
              </Button>
            </Card.Body>
          </Card>
        ...
        <Tab eventKey="feedback" title="Satisfaction by Department" onClick={() => setChartType("pie")}>
          <Card>
            <Card.Body>
              ...
              <Button onClick={() => exportToExcel(satisfactionData, "Satisfaction_by_department", chartType)} variant="primary" className="mt-3">
                Export to CSV
              </Button>
            </Card.Body>
          </Card>
