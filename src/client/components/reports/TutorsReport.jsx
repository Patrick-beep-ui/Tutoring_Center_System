        ...
        <Tab eventKey="weekly" title="Tutor Performance" onClick={() => setChartType("bar")}>
          <Card>
            <Card.Body>
              ...
              <Button variant="primary" onClick={() => exportToCSV(performanceData, "Tutor Performance", chartType)}>
                Export to CSV
              </Button>
            </Card.Body>
          </Card>
        ...
        <Tab eventKey="hourly" title="Hours by Tutor" onClick={() => setChartType("bar")}>
          <Card>
            <Card.Body>
              ...
              <Button variant="primary" onClick={() => exportToCSV(hoursData, "Hours by Tutor", chartType)}>
                Export to CSV
              </Button>
            </Card.Body>
          </Card>
        ...
        <Tab eventKey="completion" title="Subjects Covered" onClick={() => setChartType("pie")}>
          <Card>
            <Card.Body>
              ...
              <Button variant="primary" onClick={() => exportToCSV(subjectsData, "Subjects Covered", chartType)}>
                Export to CSV
              </Button>
            </Card.Body>
          </Card>
        ...
        <Tab eventKey="feedback" title="Availability Analysis" onClick={() => setChartType("pie")}>
          <Card>
            <Card.Body>
              ...
              <Button variant="primary" onClick={() => exportToCSV(availabilityData, "Tutor Availability", chartType)}>
                Export to CSV
              </Button>
            </Card.Body>
          </Card>
